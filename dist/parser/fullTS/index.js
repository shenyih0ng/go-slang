...
class FullTSParser {
    parse(programStr, context, options, throwOnError) {
        ...
        const ast = (0, parser_1.parse)(programStr, Object.assign(Object.assign({}, utils_2.defaultBabelOptions), { sourceFilename: options === null || options === void 0 ? void 0 : options.sourceFile, errorRecovery: throwOnError !== null && throwOnError !== void 0 ? throwOnError : true }));
