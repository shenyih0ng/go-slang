...
export declare const functionExpression: (params: es.Pattern[], body: es.Statement[] | es.BlockStatement, loc?: es.SourceLocation | null, id?: es.Identifier) => es.FunctionExpression;
...
export declare const assignmentExpression: (left: es.Identifier | es.MemberExpression, right: es.Expression, loc?: es.SourceLocation | null) => es.AssignmentExpression;
...
export declare const forStatement: (init: es.VariableDeclaration | es.Expression, test: es.Expression, update: es.Expression, body: es.Statement, loc?: es.SourceLocation | null) => es.ForStatement;
