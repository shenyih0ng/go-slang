...
export declare function isNode(v: any): boolean;
...
export declare enum ForFormType {
...
export declare const EmptyStmt: EmptyStatement;
...
export declare function isCommand(v: any): boolean;
...
export declare const ChanRecv: () => ChanRecvOp;
...
export declare const PopS: PopSOp;
export interface PopTillMOp extends Command {
    type: CommandType.PopTillMOp;
    markers: Marker[];
}
export declare const PopTillM: (...markers: Marker[]) => PopTillMOp;
...
export declare const RetMarker: () => {
    type: MarkerType;
};
export declare const ForStartMarker: () => {
    type: MarkerType;
};
export declare const ForPostMarker: () => {
    type: MarkerType;
};
