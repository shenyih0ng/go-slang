...
export type TSTypeAnnotationType = 'TSTypeAnnotation' | 'TSFunctionType' | 'TSUnionType' | 'TSIntersectionType' | 'TSLiteralType' | 'TSArrayType' | 'TSParenthesizedType';
export type TSTypeKeyword = 'TSAnyKeyword' | 'TSBigIntKeyword' | 'TSBooleanKeyword' | 'TSNeverKeyword' | 'TSNullKeyword' | 'TSNumberKeyword' | 'TSObjectKeyword' | 'TSStringKeyword' | 'TSSymbolKeyword' | 'TSUndefinedKeyword' | 'TSUnknownKeyword' | 'TSVoidKeyword';
export type TSOnlyNode = 'TSTypeAliasDeclaration' | 'TSAsExpression' | 'TSInterfaceDeclaration' | 'TSTypeReference';
export type TSNode = TSTypeAnnotation | TSFunctionType | TSUnionType | TSIntersectionType | TSTypeAliasDeclaration | TSInterfaceDeclaration | TSAsExpression | TSTypeReference;
export type TSType = TSKeywordType | TSFunctionType | TSUnionType | TSIntersectionType | TSTypeReference | TSLiteralType | TSArrayType | TSParenthesizedType;
