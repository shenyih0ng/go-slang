...
const source_1_typed = require("./source_1_typed.json");
const source_2 = require("./source_2.json");
const source_2_typed = require("./source_2_typed.json");
...
const source_3_typed = require("./source_3_typed.json");
const source_4 = require("./source_4.json");
const source_4_typed = require("./source_4_typed.json");
// (18 March 2022)
