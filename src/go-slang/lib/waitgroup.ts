export class WaitGroup {
  ...
  protected getCount(): number { return this.memory.getFloat32(this.COUNT_OFFSET) }

  protected setCount(value: number): number { this.memory.setFloat32(this.COUNT_OFFSET, value); return value; }

  public add(n: number): void { this.setCount(this.getCount() + n) }

  public done(): number { return this.setCount(this.getCount() - 1) }
